...
- Name: inventory_movements_negative.spec.js >> Inventory Movements Negative Flows >> Cross-claiming: operator cannot access movements page and claim movements
- Location: e2e/inventory_movements_negative.spec.js:58:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:9901/login
Call log:
  - navigating to "http://localhost:9901/login", waiting until "load"
