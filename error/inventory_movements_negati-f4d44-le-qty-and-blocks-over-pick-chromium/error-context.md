...
- Name: inventory_movements_negative.spec.js >> Inventory Movements Negative Flows >> QC quarantine exclusion: outbound on QC-held product reduces available qty and blocks over-pick
- Location: e2e/inventory_movements_negative.spec.js:29:3
