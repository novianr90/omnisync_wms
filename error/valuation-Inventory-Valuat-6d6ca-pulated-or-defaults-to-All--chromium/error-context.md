...
- Name: valuation.spec.js >> Inventory Valuation & Aging Report >> category filter option list is populated (or defaults to All)
- Location: e2e/valuation.spec.js:86:3
