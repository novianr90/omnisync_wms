...
- Name: inventory_movements_negative.spec.js >> Inventory Movements Negative Flows >> Out-of-stock dispatch: outbound qty exceeding available stock is rejected
- Location: e2e/inventory_movements_negative.spec.js:10:3
