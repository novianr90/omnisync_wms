...
- Name: auth_rbac_negative.spec.js >> Authentication & RBAC Negative Flows >> Non-system-admin blocked from /wms/system/roles — shows Access Denied
- Location: e2e/auth_rbac_negative.spec.js:40:3
