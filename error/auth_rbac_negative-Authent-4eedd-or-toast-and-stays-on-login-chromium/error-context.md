...
- Name: auth_rbac_negative.spec.js >> Authentication & RBAC Negative Flows >> Invalid login: non-existent email shows error toast and stays on /login
- Location: e2e/auth_rbac_negative.spec.js:17:3
