...
- Name: kitting.spec.js >> Kitting / Light Assembly E2E Flows >> Kitting Order Cycle: Create Assembly Order -> Verify dropdowns -> Journalize -> Verify output
- Location: e2e/kitting.spec.js:11:3
