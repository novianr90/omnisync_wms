...
- Name: inventory_movements.spec.js >> Inventory Movements & FIFO Outbound E2E Flows >> Outbound FIFO Validation: Fail over-limit -> Succeed within limit -> Deplete stock
- Location: e2e/inventory_movements.spec.js:83:3
