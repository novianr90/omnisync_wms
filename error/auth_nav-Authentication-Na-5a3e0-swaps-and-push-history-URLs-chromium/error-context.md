...
- Name: auth_nav.spec.js >> Authentication & Navigation E2E Flows >> Verify sidebar navigation links work (HTMX partial swaps) and push history URLs
- Location: e2e/auth_nav.spec.js:34:3
