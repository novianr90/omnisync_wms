...
- Name: kitting_adjustments_negative.spec.js >> Kitting & Adjustments Negative Flows >> Invalid adjustment: submitting adjustment without reason code is blocked by HTML5 validation
- Location: e2e/kitting_adjustments_negative.spec.js:61:3
