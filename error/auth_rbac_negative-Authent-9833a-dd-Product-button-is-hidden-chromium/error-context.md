...
- Name: auth_rbac_negative.spec.js >> Authentication & RBAC Negative Flows >> POS role blocked from modifying masters — Add Product button is hidden
- Location: e2e/auth_rbac_negative.spec.js:29:3
