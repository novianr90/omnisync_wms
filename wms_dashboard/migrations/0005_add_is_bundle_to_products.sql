...
('prod-005', 'BDL-MS-KB', 'Logitech Mouse + Keychron Keyboard Bundle', 'Complete workspace input accessories bundle', 'Electronics', 179.99, 1, 'uom-pack-002', CURRENT_TIMESTAMP);
